...
public interface StoreRepository extends JpaRepository<Store, Long> {
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    StoreDto findNearestStoreWithinRadiusByTime(@Param("latitude") Double courierLatitude, @Param("longitude") Double courierLongitude,
                                                @Param("radius") Double radius, @Param("courierId") Long courierId,
