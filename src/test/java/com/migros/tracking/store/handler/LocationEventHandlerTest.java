...
class LocationEventHandlerTest {
    ...
    void shouldSaveEntranceWhenNearestStoreIsFound() {
        ...
        when(courierService.getLocationsGreaterThan(locationRequest.courierId(), lastEntranceTime, PageRequest.of(0, 50))).thenReturn(
                firstPageResponse);
        when(courierService.getLocationsGreaterThan(locationRequest.courierId(), lastEntranceTime, PageRequest.of(1, 50))).thenReturn(
                secondPageResponse);
